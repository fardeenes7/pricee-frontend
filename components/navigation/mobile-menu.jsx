export default function MobileMenu({ user, navigation }) {
  return (
    <div class="flex min-h-screen flex-col justify-between border-e bg-white">
      <div class="px-4 py-6">
      ...
      <div class="sticky inset-x-0 bottom-0 flex justify-between gap-2 border-t border-gray-100">
        <a
          href="#"
        ...
        <button className="bg-accent-1 px-2 py-2 font-bold text-white hover:bg-accent-2 active:scale-95 ">
          Logout
        </button>
      </div>
    </div>
